...
const membership_cron_service_1 = require("./membership-cron.service");
...
exports.MembershipModule = MembershipModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [membership_service_1.MembershipService, membership_cron_service_1.MembershipCronService],
